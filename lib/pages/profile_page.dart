            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Mr. Marcos Lopes', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text('CEO', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    padding: EdgeInsets.all(10),
                    child: Column(
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ...
                                        ListTile(
                                          ...
                                          title: Text("Email"),
                                          subtitle: Text("marcoos@gmail.com"),
                                        ),
                                        ListTile(
                                        ...
                                        ListTile(
                                          ...
                                          subtitle: Text(
                                              "Este é um link sobre mim e você pode saber sobre mim nesta seção."),
                                        ),
                                      ],
                                    ),
                                  ],
